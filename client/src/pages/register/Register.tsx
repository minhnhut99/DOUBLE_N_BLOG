...
const Register = () => {
  ...
  const handleClickBtnRegister: SubmitHandler<FormValues> = async ({ name, username, password, gender, email, birthday, phone, address }) => {
    registerMutation.mutateAsync(
      { name, username, password, gender, email, birthday, phone, address }
    )
    navigate("/login")
  }
              ...
              <div>
                <div className='register-form-item'>
                  ...
                  <Icon
                    ...
                    icon={isShowPassword ? EYE_SHOW_ICON : EYE_HIDDEN_ICON} classNameAdditional='eye-show-hidden' />
                </div>
                <small className='error-alert'>
              ...
              <div>
                <div className='register-form-item'>
                  ...
                  <Icon
                    ...
                    icon={isShowConfirmPassword ? EYE_SHOW_ICON : EYE_HIDDEN_ICON} classNameAdditional='eye-show-hidden' />
                </div>
                <small className='error-alert'>
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange, onBlur } }) => (
                      <Input
                        ...
                        onBlur={onBlur}
                        name="birthday"
                        onFocus={() => (document.getElementsByName("birthday")[0] as HTMLInputElement).type = 'date'
                        } />
                    )}
                    name="birthday"
                  />
